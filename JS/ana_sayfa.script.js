document.addEventListener('DOMContentLoaded', function() {
    ...
    [ 
        ...
        { resim: 'images/personel-piknik-programi_9118.jpg', baslik: 'Yaz Sezonunu Piknikle Açtık', aciklama: 'Yoğun çalışma temposuna mola vererek tüm birimlerimizin katıldığı bir piknik organizasyonu düzenledik.' }, 
        { resim: 'images/stajyer-film-okuma-programi_3604.jpg', baslik: 'Stajyerlerle Film Okuma Etkinliği', aciklama: 'Gençlerimizin vizyonunu geliştirmek amacıyla film okuma ve analiz programları düzenliyoruz.' }, 
        { resim: 'images/personel-ftar-programi_3732.jpg', baslik: 'İkinci Geleneksel İftar Buluşması', aciklama: 'Personelimiz ve aileleriyle birlikte Ramazan ayının bereketini paylaştığımız iftar programımız.' }, 
        { resim: 'images/stajyer-donem-sonu-etkinligi_6028.jpg', baslik: 'Stajyer Dönem Sonu Veda Programı', aciklama: 'Staj dönemini başarıyla tamamlayan öğrencilerimiz için bir veda ve teşekkür etkinliği düzenlendi.' }, 
        { resim: 'images/stajyer-oriantasyonu_2177.jpg', baslik: 'Yeni Stajyerlerimize "Hoş Geldin" Dedik', aciklama: 'Belediye çalışmalarını yakından tanımaları için yeni stajyerlerimize yönelik bir oryantasyon yapıldı.' }, 
